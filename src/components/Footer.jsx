                ...
                <div class="mx-auto w-full p-4 py-6 lg:py-8">
                    <div class="md:flex md:justify-between">
                        ...
                        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            <div>
                                <h2 class="mb-6 font-extrabold uppercase">Services</h2>
                                <ul class="text-body">
                                    <li class="mb-4">
                                        <a href="#" class="hover:underline ">Advertising</a>
                                    </li>
                                    <li class="mb-4">
                                        <a href="#" class="hover:underline">Content marketing</a>
                                    </li>
                                    <li class="mb-4">
                                        <a href="#" class="hover:underline">Content writing</a>
                                    </li>
                                    <li>
                            ...
                            <div>
                                <h2 class="mb-6 font-extrabold uppercase">Follow us</h2>
                                <ul class="text-body font-medium">
                                    <li class="mb-4">
                                        <a href="https://github.com/abhijithpr08" class="hover:underline ">Github</a>
                                    </li>
                                    <li>
                            ...
                            <div>
                                <h2 class="mb-6 font-extrabold uppercase">Legal</h2>
                                <ul class="text-body font-medium">
                                    <li class="mb-4">
                    ...
                    <div class="sm:flex sm:items-center sm:justify-between">
                        <span class="text-sm text-body sm:text-center">© 2023 <a href="https://flowbite.com/" class="hover:underline">agency.ai™</a>. All Rights Reserved.
                        </span>
